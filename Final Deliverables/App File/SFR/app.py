...
import ibm_db
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=815fa4db-dc03-4c70-869a-a9cc13f33084.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=30367;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=ypr39908;PWD=QdNojJB1SglajC9F",'','')
...
def new_student():
    ...
    message = Mail(from_email="arunarunnagai@gmail.com",to_emails="arunarunnagai@gmail.com",subject="Account Registered Successfully",html_content="<p>Your account has been created using you provided email address.</p>")
